const openModal = (filledPhoto) => {
  ...
  commentImageElement.src = filledPhoto.comments[1].avatar;
  commentImageElement.alt = filledPhoto.comments[3].name;

  commentPhotoElement.querySelector('.social__text').textContent = filledPhoto.comments[2].message;
